...
import AddFinancialReport from "./actions";
import { useGetAllFinancialInformation } from "../../api-hook";
import { Edit, Eye, Trash } from "lucide-react";
import Delete from "@/components/ui/Delete";
import { deleteFinancialInformation } from "../../api-hook/mutations";
...
export default function FinancialInformation() {
  ...
  const { data, isLoading, refetch } = useGetAllFinancialInformation();
  ...
  const handleDelete = async () => {
    try {
      ...
      await deleteFinancialInformation(
        selectedRow._id,
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="h-11 bg-gray-100">Main title</TableHead>
            ...
            {data
              ...
              ?.map((el) => (
                <React.Fragment key={el?._id}>
                  ...
                  {el.sections.map((quarter) => (
                    <TableRow key={quarter.title}>
