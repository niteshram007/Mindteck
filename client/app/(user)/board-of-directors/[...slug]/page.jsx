...
export async function generateMetadata({ params }) {
  ...
  if (!memberId) {
    return buildLeadershipMetadata({
      member: {},
      basePath: "/board-of-directors",
      teamLabel: "Board of Directors",
    });
  }
    ...
    <div className="page-container bg-gray-100 font-inter pt-2">
      ...
      <section className="mt-3">
        <div className="container">
          ...
          <Breadcrumbs paths={["Board of Directors", data.fullName]} />
      ...
      <LeadershipSlider data={allMember || []} path={"/board-of-directors"} />
