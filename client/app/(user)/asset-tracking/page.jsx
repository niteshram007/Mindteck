import Banner from "../../assets/images/asset-tracking/banner.png";
import WhyChoose from "../../assets/images/asset-tracking/asset-tracking.png";
import FreeAssessment from "../../assets/images/asset-tracking/connect-with-us.png";
...
export const metadata = getStaticPageMetadata("/asset-tracking");
    ...
    <div className="page-container bg-gray-100 font-inter pt-2 overflow-x-hidden">
      ...
      <section className=" mt-3  z-10 relative">
        ...
        <div className="container">
          ...
          <Breadcrumbs paths={["Asset Tracking"]} />
          <motion.h2
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.1 }}
          ...
          <div className="grid grid-cols-12 sm:gap-10 gap-2">
            ...
            >
              <h3 className="text-black text-3xl  font-athelas font-normal">
                Asset Tracking Intelligence for Efficient,
                <br /> Data-Driven Operations
              </h3>

              <p className="text-md text-black my-4 text-justify">
                Mindteck's Asset Tracking Solutions, powered by our deep
                expertise in IoT and embedded systems, provide the intelligence
                you need to monitor, manage, and optimize your physical assets.
                We deliver end-to-end solutions that connect your assets,
                operations, and services, enabling data-driven decisions and
                significant improvements in efficiency, productivity, and ROI.
              </p>
            </motion.div>
          ...
          <div className="bg-white rounded-[28px] shadow-[0_22px_45px_rgba(15,23,42,0.12)] flex flex-col md:flex-row items-stretch overflow-hidden border border-[#E7E1D3]">
            <div className="w-full md:w-3/5 px-6 py-8 md:px-10 md:py-12 lg:pr-12">
              ...
              <p className="text-base md:text-[19px] leading-8 text-[#303030] mb-8">
                connect with Mindteck today to transform your asset tracking
                with intelligent, end-to-end IoT solutions.
              </p>
